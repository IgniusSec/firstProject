...
class ProductServiceTest {
    ...
    @Test
    @DisplayName("Verificando se objeto foi deletado do BD")
    ...
    @Test
    @DisplayName("Verifica se levanta uma exceção se o objeto não existe no BD")
    ...
    @Test
    @DisplayName("Verifica se findall retorna os dados paginados")
    ...
    @Test
    @DisplayName("Verifica a busca de um produto por um id existente")
